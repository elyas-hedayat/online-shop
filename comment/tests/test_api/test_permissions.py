...
class OwnerPermissionTest(BaseAPIPermissionsTest):
    ...
    def test_get_request(self):
        ...
        self.assertTrue(
            self.permission.has_object_permission(request, self.view, self.comment_1)
        )
...
class CanChangeFlaggedCommentStateTest(BaseAPIPermissionsTest):
    ...
    def test_can_change_for_flagged_comment(self):
        self.assertIs(
            ...
            self.permission.has_object_permission(
                self.request, self.view, self.flagged_comment
            ),
        )
    ...
    def test_cannot_change_for_unflagged_comment(self):
        self.assertIs(
            False,
            self.permission.has_object_permission(
                self.request, self.view, self.unflagged_comment
            ),
        )
