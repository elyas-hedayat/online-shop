...
class Comment(models.Model):
    ...
    email = models.CharField(
        max_length=125, null=True, blank=True, verbose_name="ایمیل یا نام"
    )
    ...
    accepted = models.BooleanField(default=False, verbose_name="نمایش ؟")
    ...
    def _set_email(self):
        if self.user:
            self.email = getattr(self.user, self.user.phone_number, "")
