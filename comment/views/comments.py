...
from comment.mixins import CanCreateMixin, CanDeleteMixin, CanEditMixin
from comment.models import Comment
from comment.responses import UTF8JsonResponse
from comment.utils import CommentFailReason, get_comment_from_key, get_user_for_request
from comment.views import BaseCommentView, CommentCreateMixin
...
class CreateComment(CanCreateMixin, CommentCreateMixin):
    ...
    def form_valid(self, form):
        ...
        self.data = render_to_string(
            self.get_template_names(), self.get_context_data(), request=self.request
        )
