...
COMMENT_FROM_EMAIL = getattr(
    settings, "EMAIL_HOST_USER", None
)  # used for sending confirmation emails
COMMENT_CONTACT_EMAIL = (
    COMMENT_FROM_EMAIL  # used for contact address in confirmation emails
)
...
COMMENT_RESPONSE_FOR_BLOCKED_USER = (
    "You cannot perform this action at the moment! Contact the admin for more details"
)
